...
{% img left /images/blog/Foto_prototipo2-300x295.jpg "Foto do protótipo - Módulo Registrador (Arduino)" %}
...
{% img right /images/blog/ArduinoDuemilanove-300x187.png "Arduino Duemilanove" %}
...
* A placa [Arduino Duemilanove](http://arduino.cc/en/Main/arduinoBoardDuemilanove)
* O sensor de temperatura [DS18S20](http://www.maxim-ic.com/datasheet/index.mvp/id/2815)
* O relógio de tempo real [DS1302](http://www.maxim-ic.com/datasheet/index.mvp/id/2685)
* Uma [Ethernet Shield](http://www.arduino.cc/en/Main/ArduinoEthernetShield)

{% img left /images/blog/IMG_10288_600-150x150.jpg Sensor de Temperatura DS18S20 %}
...
{% img right /images/blog/17810-img_3251_pl-150x150.jpg DS1302 e o Cristal %}
